    ...
    >
      <div className="space-y-6">
        ...
        <AdminDataCard
          ...
          description={
            !loading ? (
              <p className="text-[10px] font-black text-muted-foreground tracking-wide px-1">
              ...
              <AdminTableBody>
                {permissions.map((permission) => (
                  <AdminTableRow key={permission.id}>
                    ...
                    <AdminTableCell>
                      <Badge variant="outline" className="capitalize border-primary/20 bg-primary/5 text-primary rounded-md text-[9px] font-black whitespace-nowrap">
