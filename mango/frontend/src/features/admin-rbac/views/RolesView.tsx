                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {role.permissions && role.permissions.length > 0 ? (
                          role.permissions.slice(0, 4).map((permission) => (
                            <Badge key={permission} variant="outline" className="border-primary/20 bg-primary/5 text-primary rounded-md text-[9px] font-black whitespace-nowrap">
                              {permission}
                            </Badge>
                          ))
                        ) : (
                        ...
                        {role.permissions && role.permissions.length > 4 && (
                          <Badge variant="secondary" className="rounded-md text-[9px] font-black whitespace-nowrap">+{role.permissions.length - 4}</Badge>
                        )}
                      </div>
                    </AdminTableCell>
                    <AdminTableCell className="hidden md:table-cell">
                      <Badge variant="secondary" className="rounded-md text-[9px] font-black whitespace-nowrap">{role.guard_name || "web"}</Badge>
                    </AdminTableCell>
