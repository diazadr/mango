      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/3 flex flex-col shrink-0">
            ...
            >
              <h2 className="text-4xl lg:text-5xl font-heading font-bold text-foreground leading-tight mb-6 ">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span
                          className={`font-bold text-lg lg:text-xl font-heading transition-colors duration-300 pr-8 ${
                            isOpen
                              ? "text-primary"
