...
export const ArticleSection = () => {
  ...
  // Empty state will be handled inside the section rendering
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-card/90 backdrop-blur shadow-sm rounded-lg text-xs font-bold text-primary tracking-wider">
                ...
                <div className="flex flex-col flex-1">
                  <time className="text-xs font-semibold text-muted-foreground mb-3 tracking-wide">
                  ...
                  <div className="mt-auto pt-4 border-t border-border">
                    <Link
                      href={`/blog/${article.slug}`}
                      className="text-sm font-bold text-foreground flex items-center gap-1 group-hover:gap-2 group-hover:text-accent transition-all tracking-wide"
                    >
                      {t("read_more")}
