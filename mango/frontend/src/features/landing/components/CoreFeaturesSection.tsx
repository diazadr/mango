                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="pt-2 flex-1">
                                                <h3
                                                    className={`text-xl lg:text-2xl font-heading font-bold tracking-tight mb-2 transition-colors duration-500
