                ...
                return (
                    ...
                    >
                        ...
                        <motion.span 
                            ...
                            className="text-orange-600 font-mono font-bold tracking-wide text-xs sm:text-sm text-center drop-shadow-[0_0_8px_rgba(249,115,22,0.3)] z-10"
                        >
                ...
                return (
                    ...
                    >
                        ...
                        <motion.div 
                            ...
                            viewport={{ once: false, margin: "-50px" }}
                            transition={{ duration: 0.5, delay: 0.2 }}
                            className="bg-accent text-accent-foreground px-3 sm:px-4 py-1.5 sm:py-2 font-bold tracking-wide text-[10px] sm:text-xs flex items-center gap-2 rounded-full shadow-lg shadow-accent/20 z-10 whitespace-nowrap"
                        >
                ...
                return (
                    ...
                    >
                        <motion.span 
                            ...
                            viewport={{ once: false, margin: "-50px" }}
                            transition={{ duration: 0.5 }}
                            className="text-orange-600 font-mono font-bold tracking-wide text-xs sm:text-sm z-10"
                        >
                            Resource Drain
                        </motion.span>
                        <motion.div 
    ...
    return (
        <section className="min-h-screen flex flex-col justify-center py-16 md:py-24 bg-background relative overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10 flex-1 flex flex-col justify-center">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-4 sm:mb-6 leading-tight tracking-tight">
                        {coloredTitle}
                    </h2>
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center gap-3 sm:gap-4">
                                            ...
                                            <h3 className={`text-lg sm:text-xl lg:text-2xl font-heading font-bold transition-colors duration-300 ${activeProblem === id ? 'text-primary' : 'text-foreground/80 group-hover:text-foreground'}`}>
                                                {t(`items.${id}.title`)}
                                            </h3>
                                        </div>
