...
//               className="text-left" 
//             >
//               <h2 className="text-4xl lg:text-5xl xl:text-6xl font-heading font-bold text-white leading-tight tracking-tight ">
...
//                           <h4 className="text-sm md:text-base font-bold font-heading text-blue-400 tracking-wide leading-tight">
//                             {testimonials[currentIndex].company}
//                           </h4>
//                           <p className="text-[11px] md:text-xs font-bold text-white tracking-wider mt-1">
