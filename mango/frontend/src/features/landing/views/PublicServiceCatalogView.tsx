        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-4xl mb-20">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary text-[10px] font-black tracking-wide mb-6"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl lg:text-7xl font-bold text-foreground mb-8 tracking-tight leading-[0.95]"
            >
              Katalog <span className="text-primary">{t("layanan")}</span> <br />Penuh MANGO
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <Link href={service.link}>
                  <Button className="w-full h-12 rounded-2xl font-black tracking-wide group-hover:scale-[1.02] transition-transform">
          ...
          <div className="bg-slate-950 rounded-[3rem] p-12 lg:p-20 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl lg:text-5xl font-bold mb-8 tracking-tight leading-tight">
                  Integrasi <span className="text-primary">{t("ekosistem")}</span> <br />Manufaktur Cerdas
                </h2>
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-bold tracking-wide text-slate-500">{t("ikm_terdaftar")}</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-3xl font-black text-primary">50+</p>
                    <p className="text-xs font-bold tracking-wide text-slate-500">{t("ahli_industri")}</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-3xl font-black text-primary">20+</p>
                    <p className="text-xs font-bold tracking-wide text-slate-500">{t("fasilitas_mesin")}</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-3xl font-black text-primary">5+</p>
                    <p className="text-xs font-bold tracking-wide text-slate-500">{t("kawasan_industri")}</p>
                  </div>
                </div>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <FeatureCard icon={<Factory />} title={t("title_fasilitas_produksi")} desc="Akses mesin CNC, Injection Molding, dan 3D Print." />
                <FeatureCard icon={<Globe />} title={t("title_akses_pasar")} desc="Promosikan produk IKM ke jaringan bisnis nasional." />
                <FeatureCard icon={<BarChart3 />} title={t("title_efisiensi_biaya")} desc="Optimasi proses produksi dengan teknologi digital." />
                <FeatureCard icon={<Users />} title={t("title_jejaring_bisnis")} desc="Berhubungan langsung dengan vendor dan pemasok." />
              </div>
            </div>
          </div>
        </div>
...
const FeatureCard = ({ icon, title, desc }: { icon: any, title: string, desc: string }) => (
  <div className="p-6 bg-white/5 border border-white/10 rounded-[2rem] hover:bg-white/10 transition-colors">
    ...
    <h4 className="font-bold mb-1 text-sm tracking-tight">{title}</h4>
