      ...
      <div className="w-full max-w-md my-auto">
        <div className="mb-10 text-center">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              {t.rich("description_custom", {
                email: (chunks: any) => <span className="font-bold text-foreground">{chunks}</span>,
                emailVal: user?.email
              })}
            </p>
        </div>
        ...
        <div className="space-y-6">
            <div className="bg-muted/30 p-5 rounded-2xl text-left border border-border/50">
                <h4 className="text-xs font-bold tracking-wide mb-3 flex items-center gap-2">
                    <CheckCircle2 size={14} className="text-primary" /> {t("next_steps_title")}
                </h4>
            ...
            <div className="grid grid-cols-1 gap-4">
                ...
                >
                    {isLoading ? <Loader2 size={18} className="animate-spin" /> : t("resend_email")}
                </Button>
            </div>
