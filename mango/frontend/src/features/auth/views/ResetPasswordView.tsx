      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-secondary">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-bold font-heading mb-4">
            Akses <span className="text-accent">{t("aman")}</span>
          </h2>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-xs font-bold text-muted-foreground tracking-wide ml-1">
                {t("email_label")}
              </Label>
              <Input 
                id="email" 
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-xs font-bold text-muted-foreground tracking-wide ml-1">
            ...
            <div className="space-y-2">
              <Label htmlFor="password_confirmation" className="text-xs font-bold text-muted-foreground tracking-wide ml-1">
              ...
              <Input 
                ...
                disabled={isLoading}
                placeholder={t("placeholder_text_1")}
            ...
            >
              {isLoading ? (
                <>
                  ...
                  <span>{t("sedang_memperbarui")}</span>
                </>
              ) : (
          ...
          <div className="mt-12 pt-8 border-t border-border/50 text-center lg:text-left">
            <p className="text-[10px] text-muted-foreground tracking-[0.2em] font-black">
