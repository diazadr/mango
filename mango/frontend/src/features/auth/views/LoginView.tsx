      ...
      <div className="absolute top-6 left-6 z-50">
        <Link href="/">
          <Button 
            variant="outline" 
            size="sm" 
            className="rounded-xl font-bold bg-background/80 backdrop-blur-md border border-border/50 shadow-sm text-foreground hover:text-primary hover:bg-background transition-all active:scale-95"
          >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-secondary overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-bold font-heading mb-4">
            {t.rich("hero_title", {
              accent: (chunks) => (
                <span className="text-primary dark:text-accent">{chunks}</span>
              ),
            })}
          </h2>
        ...
        <div className="w-full max-w-md my-auto">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-muted-foreground">
              {t.rich("subtitle", {
                accent: (chunks) => (
                  <span className="text-primary dark:text-accent font-semibold">{chunks}</span>
                ),
              })}
            </p>
          </div>
