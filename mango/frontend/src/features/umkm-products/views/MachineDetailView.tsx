...
export const MachineDetailView = ({
  ...
  onDelete
    ...
    const t = useTranslations("MachineDetailView");
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl rounded-[2.5rem] p-0 overflow-hidden border-none shadow-2xl">
        ...
        <div className="p-10 space-y-8">
          <div>
            <div className="flex items-center justify-between mb-2">
              <p className="text-[10px] font-bold text-primary tracking-wide">{machine.brand || 'Tanpa Merk'}</p>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <p className="text-[10px] font-bold text-muted-foreground tracking-wide">{t("deskripsi_spesifikasi")}</p>
            ...
            {machine.notes && (
                <div className="bg-muted/20 p-4 rounded-2xl flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                        <p className="text-[10px] font-bold text-muted-foreground tracking-wide">{t("catatan_tambahan")}</p>
        ...
        <DialogFooter className="p-10 pt-0 flex gap-3">
          ...
          >
            <Pencil size={18} />{t("edit_data_mesin")}</Button>
          <Button 
            variant="ghost" 
