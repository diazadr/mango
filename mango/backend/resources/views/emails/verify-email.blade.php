...
<head>
    ...
    <title>Verifikasi Email Anda - MANGO</title>
    <!--[if gte mso 9]>
    <xml>
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Verifikasi alamat email Anda untuk mengakses platform MANGO"
    }
    </script>
</head>
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <h2>Halo, {{ $name }}!</h2>
                <p>Terima kasih telah bergabung dengan platform MANGO. Kami senang Anda ada di sini.</p>
                ...
                <p>Tautan ini akan kedaluwarsa dalam 60 menit. Jika Anda tidak merasa mendaftar di MANGO, Anda dapat mengabaikan email ini.</p>
