            ...
            'institutions' => $this->whenLoaded(
                ...
                fn () => $this->institutions
                    ->map(fn ($institution) => [
                        ...
                        'logo_url' => $institution->getFirstMediaUrl('logos', 'thumb') ?: null,
                        'department_id' => $institution->pivot->department_id ?? null,
                    ])
                    ->values()
            ),
            ...
            'organizations' => $this->whenLoaded(
                ...
                fn () => $this->organizations
                    ->map(fn ($org) => [
                        'id' => $org->id,
                        'name' => $org->name,
                        'logo_url' => $org->getFirstMediaUrl('logos', 'thumb') ?: null,
                    ])
                    ->values()
            ),
