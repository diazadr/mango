...
class OrganizationController extends Controller
{
    ...
    /**
     * List UMKMs that belong to this organization.
     */
    public function umkmList(Request $request, Organization $organization): JsonResponse
    {
        try {
            $query = $organization->umkms()->with(['user', 'institution']);
            ...
            Log::error('Organization umkmList error', ['message' => $e->getMessage()]);
            return response()->json(['message' => 'Gagal mengambil data UMKM.'], 500);
        }
    }
