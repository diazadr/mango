...
class StoreReservationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Design file: CAD, PDF, ZIP, STEP — max 100 MB
            'design_file'    => ['nullable', 'file', 'max:102400'],
    ...
    public function messages(): array
    {
        return [
            ...
            'design_file.max'           => 'Ukuran file desain maksimal 100 MB.',
            'proposed_price.numeric'    => 'Penawaran harga harus berupa angka.',
            'proposed_price.min'        => 'Penawaran harga tidak boleh kurang dari 0.',
        ];
    }
}
